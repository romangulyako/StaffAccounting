...
public class ConstantParamAndAttribute {
    ...
    public static String RESIDENCE_CITY = "residence_city";
    public static String RESIDENCE_STREET = "residence_street";
    public static String RESIDENCE_HOUSE = "residence_house";
    public static String RESIDENCE_APARTMENT = "residence_apartment";
