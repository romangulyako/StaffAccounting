...
@WebServlet(name = "positionRestoreServlet", value = "/restore_position")
public class PositionRestoreServlet extends HttpServlet {
    private static final Logger LOGGER = LoggerFactory.getLogger(PositionRestoreServlet.class);
